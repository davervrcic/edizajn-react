      ...
      return (
        <div>
              ...
              <ul>
                ...
                {/*<li>
                  ...
                  <div class="lang-dropdown">
                      <a href="index.html" title="English" class='active'>EN</a>
          ...
          <main role="main" id="work-page">
            <img src="bcg/3D-triangle-all-in-one.png" id="work-background" alt=""/>
            <section id="refs">
              <article>
                <h2 className="hidden">Our awesome work</h2>
                <p className="hidden"> We create products that users love. And this is the reason, why us as partner has selected a number of interesting clients, with whom we are working on cool a innovative projects.</p>
                <span className="button dark hidden" id="become-our-client">Become our Client</span>
